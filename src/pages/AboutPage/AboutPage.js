      ...
      <Container className='AboutPage'>
        <Row>
          ...
          <Col md={6}>
            ...
            <p>I am a Computer Science and Experience Design student based in Dallas-Fort Worth, TX. Currently, I am a UX designer for ACM UTD, where I design web applications that support ACM's operations. Previously, I have been a Designer and Corporate Relations Assistant for UTDesign — UT Dallas's engineering and computer science senior capstone program — where I designed print media, graphics, and websites for students and C-suite members alike.</p>
